...
# print(dataset)
dataset_dir = "./chip-llm/finetune/Qwen3-0.6B-medical-lora/dataset"
...
training_args = TrainingArguments(
    output_dir = "./chip-llm/finetune/Qwen3-0.6B-medical-lora/output", 
    eval_strategy = "steps", 
    eval_steps = 100, 
    num_train_epochs = 5, 
    save_steps = 400, 
    ...
    save_total_limit = 1, 
    run_name = f"Qwen3-0.6B-medical-lora-sft-{time_str}"
)
